...
class GreeterStub(object):
    ...
    def __init__(self, channel):
        ...
        self.DogSaysHello = channel.unary_stream(
                '/greet.Greeter/DogSaysHello',
                request_serializer=greet__pb2.HelloRequest.SerializeToString,
                response_deserializer=greet__pb2.HelloReply.FromString,
                )
        self.CatClientSaysHello = channel.stream_unary(
                '/greet.Greeter/CatClientSaysHello',
                request_serializer=greet__pb2.HelloRequest.SerializeToString,
...
def add_GreeterServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'DogSaysHello': grpc.unary_stream_rpc_method_handler(
                    servicer.DogSaysHello,
                    request_deserializer=greet__pb2.HelloRequest.FromString,
                    response_serializer=greet__pb2.HelloReply.SerializeToString,
            ),
            'CatClientSaysHello': grpc.stream_unary_rpc_method_handler(
                    servicer.CatClientSaysHello,
                    request_deserializer=greet__pb2.HelloRequest.FromString,
...
class Greeter(object):
    ...
    def DogSaysHello(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_stream(request, target, '/greet.Greeter/DogSaysHello',
            greet__pb2.HelloRequest.SerializeToString,
            greet__pb2.HelloReply.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    @staticmethod
    def CatClientSaysHello(request_iterator,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.stream_unary(request_iterator, target, '/greet.Greeter/CatClientSaysHello',
            greet__pb2.HelloRequest.SerializeToString,
